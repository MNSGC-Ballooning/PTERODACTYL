...
unsigned int int_latitudeGPS;
unsigned int int_longitudeGPS;
unsigned int int_altitudeFtGPS;
...
void updateDataStrings() {
  ...
  int_latitudeGPS = (ublox.getLat()) * 1000;
  int_longitudeGPS = (ublox.getLon()) * 100;
  int_altitudeFtGPS = (ublox.getAlt_feet()) * 10;

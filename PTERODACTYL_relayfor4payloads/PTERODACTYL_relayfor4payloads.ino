...
String header = "Year, Month, Day, Hour, Minute, Second, Lat, Lon, Alt(ft), AltEst(ft), intT(F), extT(F), msTemp(F), msPressure(PSI), magnetometer x, magnetometer y, magnetometer z, accelerometer x, accelerometer y, accelerometer z, gyroscope x, gyroscope y, gyroscope z";
String header2 = "ID, Combined ID, line #, Sensor 1, Sensor 2, Sensor 3, ID, Combined ID, line #, Sensor 1, Sensor 2, Sensor 3";
